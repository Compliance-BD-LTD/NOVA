...
export const Blog = () => {
    ...
    return (
        <div className='space-y-10 py-10 px-5 md:min-h-screen'  >
            {
                ...
                (
                    ...
                    <div className='text-center space-y-5'>
                        <p className='text-3xl md:text-5xl font-semibold'>  <span className='text-blue-500'>Our</span> <span>Blogs</span> </p>
                    </div>
                )
            }

            {
                blogs && blogs.length == 0 && (
                    <div className='min-h-[330px] md:mt-[10%] ' >
